...
- (UIButton *)confirmButton {
    ...
    if (!_confirmButton) {
        ...
        [_confirmButton setTitleColor:[UIColor colorWithRed:74 / 255.0 green:208 / 255.0 blue:237 / 255.0 alpha:1] forState:(UIControlStateNormal)];
